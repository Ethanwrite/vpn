...
class Application : android.app.Application() {
    ...
    override fun onCreate() {
        ...
        super.onCreate()
        XingsuiCrashReporter.install(this)
        ...
        coroutineScope.launch(Dispatchers.IO) {
            try {
                ...
                XingsuiCrashReporter.recordException("backend-init", e)
            }
        }
            ...
            try {
                ...
                for (tunnel in activeTunnels) {
                    try {
                        ...
                        XingsuiCrashReporter.recordException("network-reconnect:${tunnel.name}", e)
                    }
                }
            } catch (e: Exception) {
                if (e is CancellationException) throw e
